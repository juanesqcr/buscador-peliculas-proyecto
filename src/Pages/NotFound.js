...
<div className="container">
	<div className="left-section">
		<div className="inner-content">
			<h1 className="heading">Looks like the page you were looking for is no longer here.</h1>
			<p className="subheading">ERROR 404</p>
            <Link to="/" classNames="btnAtras">Pagina Principal</Link>
		</div>
	</div>
		...
		<svg className="svgimg" xmlns="http://www.w3.org/2000/svg" viewBox="51.5 -15.288 385 505.565">
            ...
            <g id="lamp">
                ...
                <radialGradient className="light-gradient" id="SVGID_1_" cx="119.676" cy="44.22" r="65" gradientUnits="userSpaceOnUse">
                    ...
                    <stop  offset="50%" stop-color='#EDEDED' stop-opacity= "0.5%">
